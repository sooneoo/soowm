...
static const char *const autostart[] = {
	"swaybg", "-i", "/home/petr/.config/dwl/wallpaper.png", "-m", "fill", NULL, 
        NULL /* terminate */
};
...
static uint32_t colors[][3] = {
	/*               fg          bg          border   */
	[SchemeNorm] = { 0xa9b1d6ff, 0x1a1b26ff, 0x1a1b26ff },
	[SchemeSel]  = { 0x1a1b26ff, 0xff9800ff, 0x1a1b26ff },
	[SchemeUrg]  = { 0xffffffff, 0xf7768eff, 0xf7768eff },
};
...
static const MonitorRule monrules[] = {
    ...
    * example of a HiDPI laptop monitor:
	...
	{ NULL,       0.55f, 1,      0.9f,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   -1,  -1 },
...
static const char * volumemute[] = {"wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "toggle", NULL};
static const char * microfonemute[] = {"wpctl", "set-mute", "@DEFAULT_AUDIO_SOURCE@", "toggle", NULL};
...
static const char * screenlock[] = {"waylock", "-init-color", "0x000000", "-input-color", "0x0000ff", NULL};
...
static const Key keys[] = {
    ...
    { MODKEY,                    XKB_KEY_F5,                       spawn,          {.v = microfonemute } },	
    ...
    { MODKEY|WLR_MODIFIER_SHIFT,                    XKB_KEY_l,                        spawn,          {.v = screenlock} },
